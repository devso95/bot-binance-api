...
import deso.future_bot.bot.binance.model.event.*;
import deso.future_bot.bot.binance.model.user.UserDataUpdateEvent;
import deso.future_bot.bot.binance.impl.BinanceApiInternalFactory;

import java.util.List;

/***
 * The subscription client interface, it is used for subscribing any market deso.future_bot.bot.data
...
public interface SubscriptionClient {
     ...
     * server will send the deso.future_bot.bot.data to client and onReceive in callback will be called.
     *
    ...
    /**
     * Subscribe user deso.future_bot.bot.data event. If the user deso.future_bot.bot.data is updated,
     * server will send the deso.future_bot.bot.data to client and onReceive in callback will be called.
     *
