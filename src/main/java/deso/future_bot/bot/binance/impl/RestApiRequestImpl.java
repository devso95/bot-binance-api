...
import deso.future_bot.bot.binance.impl.utils.JsonWrapperArray;
import deso.future_bot.bot.binance.impl.utils.UrlParamsBuilder;
import deso.future_bot.bot.binance.model.ResponseResult;
import deso.future_bot.bot.binance.model.enums.*;
import deso.future_bot.bot.binance.model.market.*;
import deso.future_bot.bot.binance.model.trade.*;
...
//        System.out.print(requestUrl);
        ...
        request.jsonParser = (jsonWrapper -> {
            ...
            jsonArray.forEach(obj -> {
                if (((JSONObject) obj).containsKey("code")) {
                    ...
                    o.setExecutedQty(jsonObj.getDouble("executedQty"));
                    o.setOrderId(jsonObj.getLong("orderId"));
                    o.setOrigQty(jsonObj.getDouble("origQty"));
                    o.setPrice(jsonObj.getDouble("price"));
                    o.setReduceOnly(jsonObj.getBoolean("reduceOnly"));
                    o.setSide(TradeType.valueOf(jsonObj.getString("side")));
    ...
    RestApiRequest<Order> postOrder(String symbol, OrderSide side, PositionSide positionSide, OrderType orderType,
        ...
        request.jsonParser = (jsonWrapper -> {
            ...
            result.setExecutedQty(jsonWrapper.getDouble("executedQty"));
            result.setOrderId(jsonWrapper.getLong("orderId"));
            result.setOrigQty(jsonWrapper.getDouble("origQty"));
            result.setPrice(jsonWrapper.getDouble("price"));
            ...
            result.setSide(TradeType.valueOf(jsonWrapper.getString("side")));
    ...
    RestApiRequest<Order> cancelOrder(String symbol, Long orderId, String origClientOrderId) {
        ...
        request.jsonParser = (jsonWrapper -> {
            ...
            result.setSymbol(jsonWrapper.getString("symbol"));
            result.setTimeInForce(jsonWrapper.getString("timeInForce"));
            result.setSide(TradeType.valueOf(jsonWrapper.getString("type")));
            result.setUpdateTime(jsonWrapper.getLong("updateTime"));
            result.setWorkingType(jsonWrapper.getString("workingType"));
            return result;
        });
    ...
    RestApiRequest<List<Order>> getOpenOrders(String symbol) {
        ...
        request.jsonParser = (jsonWrapper -> {
            ...
            dataArray.forEach((item) -> {
                ...
                element.setExecutedQty(item.getDouble("executedQty"));
                element.setOrderId(item.getLong("orderId"));
                element.setOrigQty(item.getDouble("origQty"));
                element.setPrice(item.getDouble("price"));
                element.setReduceOnly(item.getBoolean("reduceOnly"));
                element.setSide(TradeType.valueOf(item.getString("side")));
                ...
                element.setSymbol(item.getString("symbol"));
                element.setTimeInForce(item.getString("timeInForce"));
//                element.setType(TradeType.valueOf(item.getString("type")));
    ...
    RestApiRequest<List<Order>> getAllOrders(String symbol, Long orderId, Long startTime, Long endTime, Integer limit) {
        ...
        request.jsonParser = (jsonWrapper -> {
            ...
            dataArray.forEach((item) -> {
                ...
                element.setSymbol(item.getString("symbol"));
                element.setTimeInForce(item.getString("timeInForce"));
                element.setSide(TradeType.valueOf(item.getString("type")));
                element.setUpdateTime(item.getLong("updateTime"));
                element.setWorkingType(item.getString("workingType"));
                result.add(element);
            });
...
//        request.request = createRequestByGetWithSignature("/gateway-api//v1/public/future/deso.future_bot.bot.data/openInterestHist", builder);
        request.request = createRequestByGetWithSignature("/futures/deso.future_bot.bot.data/openInterestHist", builder);
...
//        request.request = createRequestByGetWithSignature("/gateway-api//v1/public/future/deso.future_bot.bot.data/topLongShortAccountRatio", builder);
        request.request = createRequestByGetWithSignature("/futures/deso.future_bot.bot.data/topLongShortAccountRatio", builder);
...
//        request.request = createRequestByGetWithSignature("/gateway-api//v1/public/future/deso.future_bot.bot.data/topLongShortPositionRatio", builder);
        request.request = createRequestByGetWithSignature("/futures/deso.future_bot.bot.data/topLongShortPositionRatio", builder);
...
//        request.request = createRequestByGetWithSignature("/gateway-api//v1/public/future/deso.future_bot.bot.data/globalLongShortAccountRatio", builder);
        request.request = createRequestByGetWithSignature("/futures/deso.future_bot.bot.data/globalLongShortAccountRatio", builder);
...
//        request.request = createRequestByGetWithSignature("/gateway-api//v1/public/future/deso.future_bot.bot.data/globalLongShortAccountRatio", builder);
        request.request = createRequestByGetWithSignature("/futures/deso.future_bot.bot.data/takerlongshortRatio", builder);
