...
import deso.future_bot.bot.binance.impl.BinanceApiInternalFactory;
...
public interface SyncRequestClient {
     ...
     * are implemented by synchronous mode.
     *
     * @param apiKey    The public key applied from deso.future_bot.bot.binance.
     * @param secretKey The private key applied from deso.future_bot.bot.binance.
     * @return The instance of synchronous client.
     */
    ...
    /**
     * Fetch current exchange deso.future_bot.bot.trading rules and symbol information.
     *
     * @return Current exchange deso.future_bot.bot.trading rules and symbol information.
     */
    ...
    /**
     * Start user deso.future_bot.bot.data stream.
     *
     * @return listenKey.
     */
    ...
    /**
     * Keep user deso.future_bot.bot.data stream.
     *
     * @return null.
     */
    ...
    /**
     * Close user deso.future_bot.bot.data stream.
     *
     * @return null.
     */
